...
- ef77691: fix path resolution done wrong breaking `document dev` on Windows
...
- e173b44: Use the same version for the preview-server and useprint
...
- 40fb596: Use the same version for the preview-server and useprint
...
- b947f98: Pre-render document templates on hover
...
- aae2f59: Ensure dependencies outside documents directory are completely resolved
- b4b2373: Fix non-document files being rendered during hot reloading
...
- dbf3a64: Add error message for when an document template does not have a default export

## 4.1.0-canary.0

### Minor Changes

- 4a0d4e3: Theme switcher for document template
...
- a07eebf: Pre-render document templates on hover
...
- 1a17219: fix improper `require` in `document export`
...
- 4c7f597: fix `document dev` not working with `traversal` error
...
- cd02449: Ensure dependencies outside documents directory are completely resolved
...
- ab70556: Fix non-document files being rendered during hot reloading
- 9c9aa5d: Add error message for when an document template does not have a default export
...
- 403e415: Fix `deno` not working as an option for `document build`
...
- 382c305: Fixes active state for root document templats on file tree
...
- 98b434c: Fixes active state for root document templats on file tree
...
- 7337d04: Fix documents being re-rendered each time there is navigation in the preview server
...
- 7eb68af: Fix NODE_ENV for documents as "PRODUCTION" instead of "DEVELOPMENT"
- 76183e0: Update socket.io and socket.io-client
- f295614: Add AbortSignal, Event and EventTarget
- bb79540: Add missing timers/promises Node module for `document dev`
...
- 59e27bc: Add missing timers/promises Node module for `document dev`
...
- 1af53fb: Fix NODE_ENV for documents as "PRODUCTION" instead of "DEVELOPMENT"
...
- 1a47335: Use a built version of preview app when running `document dev`

### Patch Changes

- 19cab7b: Fixes decorators causing dependency tree babel parsing to fail
- 14b7d1d: update socket.io/socket.io-client to 4.7.5
- b68e166: Fix sharp warning when running `document dev`
- 3caaf53: Updated peer dependencies to allow for React 19 release candidated and React 19 itself
- 9a5fd78: fix document template preview failing with documents having spaces
...
- b87cbbf: Fix sharp warning when running `document dev`

## 3.0.0-canary.0

### Major Changes

- f552226: Use a built version of preview app when running `document dev`

### Patch Changes

- 2799bb4: fix document template preview failing with documents having spaces
...
- Fixes live refresh not working with files outside `documents` directory
